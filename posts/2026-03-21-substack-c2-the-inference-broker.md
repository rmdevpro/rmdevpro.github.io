# The Inference Broker

This is paper 15 of 23 in the Conversationally Cognizant AI series. This paper defines the Inference Broker as the counterpart to the Context Broker — managing how inference requests reach models, how those models are configured, and how the alias system makes inference a purposeful act rather than a transaction.
...
The Context Broker provides the right information — assembling purpose-built context from the infinite conversation, delivering the right view of accumulated knowledge at the right moment.
...
Tomorrow: Paper 16 — The Conversation Broker. The foundational messaging model that enables agent-to-agent communication with clear addressing, reliable delivery, and loop protection.
