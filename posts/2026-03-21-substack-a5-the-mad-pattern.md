# The Multipurpose Agentic Duo

This is paper 5 of 23 in the Conversationally Cognizant AI series. This paper defines the MAD pattern — the core architectural unit of the ecosystem — where each agent is simultaneously a server and a client, governed by the same domain intelligence in both roles.
...
Within this architecture there are two distinct agent classes. Understanding their differences is essential to understanding how the ecosystem works. The distinction is grounded in the primitives defined in the foundational paper: Identity, Purpose, Intent, and Autonomy.
...
Conversation is also the vehicle for memory and cognition. Everything the system knows, everything it has learned, everything it can do — accessible through conversation.
...
Tomorrow: Paper 6 — Agentic Identity and Persona. How identity is defined by design rather than developed through experience, and how persona provides contextual expression of that stable identity.
