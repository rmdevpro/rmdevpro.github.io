# The Decision Tree Router (DTR)

This is paper 19 of 23 in the Conversationally Cognizant AI series. This paper defines the DTR — a fast, non-LLM routing component that classifies incoming requests at microsecond timescales using a continuously learning Hoeffding tree, protecting expensive reasoning agents from routine work.
...
Tomorrow: Paper 20 — Agent-Optimal Code Architecture. What code architecture should look like when agents are the primary builders and maintainers — StateGraphs as the level of abstraction, and the separation of intelligence from infrastructure.
